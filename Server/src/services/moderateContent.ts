...
export async function moderateContent(text: string) {
  try {
    ...
    SPAM RULES:
    Reject content that shows signs of spam or meaningless text such as:
    ...
    EXCEPTIONS:
    Do NOT reject content that contains the words "no", "No", or "không". These are allowed because real product descriptions may use them legitimately.
...
{"isSafe":true|false,"reason":"Lý do ngắn gọn (lý do có hỗ trợ đa ngôn ngữ - ví dụ người dùng nhập tiếng Việt thì tiếng Việt - Anh thì tiếng Anh, tương tự) hoặc 'Valid'" - không viết hoa chữ cái đầu}`;
